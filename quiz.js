...
document.addEventListener('DOMContentLoaded', () => {
    ...
    answerCards.forEach(card => {
        card.addEventListener('click', () => {
            ...
            if (currentQuestionIndex === 0 && scores.comportamentais === 0 && scores.humanista === 0 && scores.gestalt === 0 && scores.psicanalise === 0 && scores.sistemica === 0) {
                startQuiz();
            }
